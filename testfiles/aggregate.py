    ...
    if len(file_split) == 6:
        ...
        if ite == str(n_candidates) and pi == improve_initial_prompt and mi == improve_resulting_model:
            ...
            if cat not in agg_cat:
                agg_cat[cat] = {"visible_transitions": [], "self_grading": []}
...
for cat in agg_cat:
    ...
    print(cat, "visible_transitions", agg_cat[cat]["visible_transitions"], "\tself_grading", agg_cat[cat]["self_grading"])
